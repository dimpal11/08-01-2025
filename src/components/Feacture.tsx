...
export default function Feacture() {
  ...
  return (
    <>
      ...
      <div className="lg:flex justify-between container mx-auto relative xl:px-[110px] lg:top-[45px] hidden">
      ...
      <section className="container max-w-screen-xl justify-center flex relative mx-auto px-4">
        ...
        <div className="absolute top-[58px] md:top-[238px] lg:top-[300px] xl:[300px]">
          <button
